...
namespace tmap 
{
    ...
    /**
     * @brief The pointer map used for pointing to the keys from the sorted hash map.
     * 
     */
    ...
    class LSHForest
    {
        public:
             ...
             * @param store Whether or not to store the data for later enhanced (using parameter kc) retrievel.
             * @param file_backed Whether to store the data on disk rather than in RAM (experimental).
             */
            LSHForest(unsigned int d = 128, unsigned int l = 8, bool store = true, bool file_backed = false);
            ...
            /**
             * @brief Read / deserialize a LSH forest instance form the disk. The forest is indexed automatically.
             * 
            ...
            /**
             * @brief Get the MinHash of an entry at a given index. The index is defined by order of insertion.
             * 
            ...
            /**
             * @brief Get the k-nearest neighbor graph of the data stored in this LSH forest instance. It will be written to out parameters as an edge list.
             * 
             ...
             * @param[out] weight A vector to which the float weights of the edges will be written.
             * @param k The degree of the nearest neighbor graph.
             * @param kc The scalar by which k is multiplied before querying the LSH forest. The results are then ordered decreasing based on linear-scan distances and the top k results are picked to create the k-nearest neighbor graph.
             * @param weighted Whether the MinHashes contained within this instance of an LSH forest are weighted.
             */
             ...
             * @param kc The scalar by which k is multiplied before querying the LSH forest. The results are then ordered decreasing based on linear-scan distances and the top k results returned.
             * @param weighted Whether the MinHashes contained within this instance of an LSH forest are weighted.
             * @return std::vector<std::pair<float, uint32_t>> The distances and indices of the k-nearest neighbors.
             */
            ...
            /**
             * @brief Get the k-nearest neighbors of a query except those defined in the argument exclude.
             * 
             * @param vec The query MinHash.
             * @param k The number of k-nearest neighbors to return.
            ...
            /**
             * @brief Get the k-nearest neighbors of an entry except those defined in the argument exclude.
             * 
             * @param id The id of the query entry.
             * @param k The number of k-nearest neighbors to return.
             * @param exclude A list of indices to be excluded from the search.
             ...
             * @return std::vector<std::pair<float, uint32_t>> The distances and indices of the k-nearest neighbors.
             */
            std::vector<std::pair<float, uint32_t>> LinearScan(const std::vector<uint32_t> &vec, std::vector<uint32_t> &indices, unsigned int k = 10, bool weighted = false);
            ...
            /**
             * @brief Query the LSH forest for k-nearest neighbors. Exclude a list of entries by ID.
             * 
             * @param vec The query MinHash.
             * @param exclude A list of indices to be excluded from the search.
             * @param k The number of nearest neighbors to search for.
             ...
             * @param k The number of nearest neighbors to search for.
             * @return std::vector<std::vector<uint32_t>> A vector of the indices of the k-nearest neighbors.
             */
             ...
             * @param kc The scalar by which k is multiplied before querying the LSH forest. The results are then ordered decreasing based on linear-scan distances and the top k results returned.
             * @param weighted Whether the MinHashes contained within this instance of an LSH forest are weighted.
             * @return std::vector<uint32_t> The IDs of the nearest neighbors of all LSH forest entries.
             */
            std::vector<uint32_t> GetAllNearestNeighbors(unsigned int k, unsigned int kc = 10, bool weighted = false);
            
            /**
             * @brief Get the MinHash of an entry at a given index. The index is defined by order of insertion. Alias for GetHash.
             * 
             * @param id The index (order of insertion) of a entry.
             * @return std::vector<uint32_t> The MinHash associated with an index.
             */
             ...
             * 
             * @param vec The query MinHash.
             * @return std::vector<float> The distances form the input MinHash to all the entries in the LSH forest.
             */
        ...
        private:
            ...
            std::vector<spp::sparse_hash_map<std::vector<uint8_t>, std::vector<uint32_t>, SimpleHash>> hashtables_;
             ...
             */
            std::vector<std::vector<uint8_t>> GetKeysFromHashtable(spp::sparse_hash_map<std::vector<uint8_t>, std::vector<uint32_t>, SimpleHash> hashtable);
             ...
             * @param results[out] A vector to which the results of the search are written to.
             * @param k The number of nearest neighbors to search for.
             */
